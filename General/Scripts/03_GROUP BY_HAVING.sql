...
--> COUNT(컬럼명) : 해당 컬럼에 값이 행이 몇 개인지 카운트
----> NULL이면 카운트에서 제외
...
--> 부서 코드가 'D5'인 사원 중 급여가 400만 초과인 사원의 이름, 부서코드, 급여 조회
...
--> 교집합인 대북혼, 심봉선을 제외한 앞 쪽 SELECT의 RESULT SET이 조회됨
