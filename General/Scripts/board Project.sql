...
-- 계정 생성
CREATE USER SPRING_KHY IDENTIFIED BY SPRING1234;

-- 권한 부여
GRANT CONNECT, RESOURCE TO SPRING_KHY;

-- 테이블 저장 공간 할당
ALTER USER SPRING_KHY
...
COMMENT ON COLUMN "MEMBER"."MEMBER_NICNAME" IS '회원명(별명)';
...
-- 샘플 회원 데이터 삽입
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'member01@kh.or.kr', 'pass01!', '샘플1', '01012341234', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
...
UPDATE "MEMBER"
SET
	"MEMBER_PW" = '$2a$10$AQlhDFa18DqvXVoD8gprJO4iVHU5QFOCvTdWPGewCavfiiAxHpWxS'
WHERE "MEMBER_NO" = 1;
