...
INSERT INTO USER_USED_UK
VALUES(1, NULL, 'pass01', '나길동', '남', '010-1234-5678', 'hong123@kh.or.kr');
--> ORA-00001: 무결성 제약 조건(KH_KHY.USER_NAME_U)에 위배됩니다
...
-- ORA-00001: 무결성 제약 조건(KH_KHY.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_KHY.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_KHY"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_KHY.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("KH_KHY"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
-- 자식 테이블의 한 컬럼에 작성될 수 있는 값은 부모 테이블의 한 컬럼(PK, UNIQUE)에 작성된 값만 쓸 수 있음
--> 자식 테이블이 부모 테이블을 참조
...
-- ORA-02291: 무결성 제약조건(KH_KHY.GRADE_CODE_FK1)이 위배되었습니다 - 부모 키가 없습니다
...
FROM USER_GRADE
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(KH_KHY.GRADE_CODE_FK1)이 위배되었습니다 - 자식 레코드가 발견되었습니다
...
CREATE TABLE USER_USED_FK2(
  ...
  /* 컬럼 레벨로 FK 제약조건 설정 */
  	--> 컬럼 레벨 에서는 FOREIGN KEY 라는 단어를 사용하지 않음!!!!!
  GRADE_CODE NUMBER
...
-- ORA-02290: 체크 제약조건(KH_KHY.GENDER_CHECK)이 위배되었습니다
...
CREATE TABLE USER_TEST(
	...
	USER_NO NUMBER CONSTRAINT PK_USER_TEST PRIMARY KEY, -- PK
	USER_ID VARCHAR2(20) CONSTRAINT UK_USER_ID UNIQUE,
	USER_PWD VARCHAR2(20) CONSTRAINT NN_USER_PWD NOT NULL, -- NOT NULL은 컬럼 레벨만 가능!!!
	PNO CHAR(14) CONSTRAINT NN_USER_PNO NOT NULL,
...
INSERT INTO USER_TEST VALUES (1, 'ID_001', 'PW_001', '960911-2201267', '여', '010-3354-4901', NULL, 'N');
INSERT INTO USER_TEST VALUES (2, 'ID_002', 'PW_002', '881126-1041524', '남', '010-7203-9536', '충남 아산시 행목로 202', 'Y');
INSERT INTO USER_TEST VALUES (3, 'ID_003', 'PW_003', '980805-2216138', '여', '010-7216-3398', '경기도 시흥시 비둘기공원 7길 10', 'N');
INSERT INTO USER_TEST VALUES (4, 'ID_004', 'PW_004', '000816-3075684', '남', '010-5589-4236', '인천광역시 서구 청라동', 'N');
INSERT INTO USER_TEST VALUES (5, 'ID_005', 'PW_005', '710518-2253515', '여', '010-5669-4901', '경기도 성남시 분당구 정자일로 95', 'Y');
